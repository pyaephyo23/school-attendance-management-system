...
//        STUDENT TIME TABLE
//        String sql = "SELECT day_of_week, start_time, end_time, course_name, teaches_id FROM timeslot " +
...
//                "WHERE timeslot.semester_id = ? ORDER BY timeslot.day_of_week ASC, timeslot.start_time ASC;";
